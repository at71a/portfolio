...
| 2.   | [Анализ товарного ассортимента в e-commerce]([https://github.com/](https://github.com/at71a/portfolio/tree/main/ecommerce)) | Определение основного и дополнительного ассортимента магазина товаров для дома | python, pandas, matplotlib, numpy, scipy, seaborn, math, datetime, ABC-анализ, проверка гипотез |
